...
export default function RightColumn() {
  return (
    <div className="h-full md:w-2/3  space-y-4 overflow-y-scroll pb-4">
      <Tabs defaultValue="my-reccomendations" className="w-full flex flex-col  ">
        <TabsList className="w-full">
          <TabsTrigger value="my-reccomendations" className="w-full">
            My Rec&apos;s
          </TabsTrigger>
          {/* <TabsTrigger value="saved-reccomendations" className="w-full">
            Saved Rec&apos;s
          </TabsTrigger> */}
        </TabsList>
